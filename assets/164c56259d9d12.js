...
$scope.isMenuOpen=true}}});oi5('au7',($scope,$patch)=>{$scope.say_hello='Hello World!';});oi5('oo8',($scope,$patch)=>{$scope.say_hello='Hello World!';});oi5('dg2',($scope,$patch)=>{$scope.say_hello='Hello World!';});oi5('xi1',($scope,$patch,ov8,$hide,$show,mu6,jb6,ie6,bw8)=>{$scope.todos=[]
$scope.onStep=1
